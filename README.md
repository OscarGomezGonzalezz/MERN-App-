...
```
cd existing_repo
git remote add origin https://gitlab.reutlingen-university.de/cloudcomputing-oscgomgon/todo-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.reutlingen-university.de/cloudcomputing-oscgomgon/todo-app/-/settings/integrations)
